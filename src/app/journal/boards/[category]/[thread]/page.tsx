...
import { getCategory, getThread, getPostsForThread, boardCategories, type BoardCategory, type BoardThread, type BoardPost } from "@/lib/boards";
import { ThreadViewClient } from "./page";
...
export async function generateMetadata({ params }: ThreadPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      type: "article",
      title: thread.title,
      description: `Discussion in ${category?.name}`,
    },
    twitter: {
